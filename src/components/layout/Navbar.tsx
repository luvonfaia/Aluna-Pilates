    ...
    return (
        <>
            <nav className="sticky top-0 left-0 w-full z-[100]">
                {/* Top Info Bar */}
                <div className="bg-aluna-alabaster/40 backdrop-blur-sm border-b border-aluna-stone/10 py-2 sm:py-2.5 px-4 sm:px-6">
                    <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-center items-center gap-3 sm:space-x-12 text-[11px] sm:text-sm tracking-[0.2em] font-medium text-aluna-stone/80">
                        <div className="flex items-center space-x-6 sm:space-x-8">
                            <a
                                href="https://facebook.com"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="hover:text-aluna-gold transition-all duration-300 hover:scale-110"
                                aria-label="Facebook"
                            >
                        ...
                        <div className="flex items-center space-x-4 sm:space-x-8">
                            <a
                                ...
                                className="hover:text-aluna-gold transition-colors duration-300"
                            >
                                <span>hello@alunastudio.ro</span>
                            </a>
                            <span className="w-px h-3 bg-aluna-stone/20 hidden sm:block"></span>
                            <LanguageSwitcher />
                        </div>
                    </div>
                </div>
                ...
                <div
                    className={`transition-all duration-500 relative z-[160] ${(scrolled && !isOpen) ? 'bg-aluna-alabaster/95 backdrop-blur-md shadow-sm py-1' : 'bg-transparent py-2 sm:py-3'
                        }`}
                >
                            ...
                            <div className={`relative z-10 transition-opacity duration-300 ${isOpen ? 'opacity-0' : 'opacity-100'}`}>
                                <Link to="/" className="group">
                                    <img
                                        ...
                                        className={`w-auto object-contain transition-all duration-500 ${(scrolled && !isOpen) ? 'h-16 md:h-24' : 'h-24 md:h-48'
                                            }`}
                                    />
                                </Link>
                            </div>
